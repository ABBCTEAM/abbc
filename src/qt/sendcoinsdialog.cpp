    ...
    model(0)
{
	...
	ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a ABBCCoin address (e.g. CfwYhBmGXcFP2Po1NpRUEiK8km2)"));
    ...
    QAction *clipboardLowOutpABBCCointion = new QAction(tr("Copy low output"), this);
    ...
    connect(clipboardLowOutpABBCCointion, SIGNAL(triggered()), this, SLOT(coinControlClipboardLowOutput()));
    ...
    ui->labelCoinControlLowOutput->addAction(clipboardLowOutpABBCCointion);
...
void SendCoinsDialog::coinControlChangeEdited(const QString & text)
{
    if (model)
    {
        ...
        else if (!CBitcoinAddress(text.toStdString()).IsValid())
        {
            ...
            ui->labelCoinControlChangeLabel->style()->polish(ui->labelCoinControlChangeLabel);
            ui->labelCoinControlChangeLabel->setText(tr("WARNING: Invalid ABBCCoin address"));
        }
        else
        {
